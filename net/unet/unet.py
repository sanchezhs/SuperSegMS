...
#     model = smp.Unet(
#         encoder_name="resnet34", in_channels=in_channels, classes=1, activation=None
#     )
#     model.to(DEVICE)
...
#         cv2.putText(
#             padded_img, text, (text_x, text_y), font, font_scale, (0, 0, 0), thickness
#         )
...
#         pred_img = ((pred_mask > 0.5) * 255).astype(
#             np.uint8
#         )  # Remove > 0.5 for a smother image
...
#             [input_with_subtitle, ground_truth_with_subtitle, pred_with_subtitle],
#             axis=1,
#         )
...
#         os.makedirs(result_dir, exist_ok=True)
#         cv2.imwrite(
#             os.path.join(result_dir, "input.png"), (img[0] * 255).astype(np.uint8)
#         )
#         cv2.imwrite(
#             os.path.join(result_dir, "prediction.png"),
...
#         "--input_path", type=str, required=True, help="Path to read images from."
#     )
#     eval_parser.add_argument(
#         "--output_path",
#         type=str,
...
#         "predict", help="Predict using the U-Net model on test images"
#     )
#     # eval_parser.add_argument(
#     #     "--input_path",
#     #     type=str,
